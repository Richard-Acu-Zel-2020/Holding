...
namespace Holding
{
    public partial class FrmScrSolicitudEdicion : Form
    {
        ...
        #region "Función para escribir solo Números en los Textboxs"
        private void txtMontoInversion_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void txtIdObligacion_KeyPress(object sender, KeyPressEventArgs e)
        {
            //Para obligar a que sólo se introduzcan números
            if (Char.IsDigit(e.KeyChar))
            {
