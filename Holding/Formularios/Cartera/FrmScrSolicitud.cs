...
namespace Holding
{
    ...
    public partial class FrmScrSolicitud : Form
    {
        ...
        public void ModificarSolicitud()
        {
            ...
            if (dgvSolicitudes.RowCount > 0)
            {
                try
                {
                    ...
                    clsSolicitud.ObjTipoDocumentoID = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[30].Value.ToString());
                    ...
                    clsSolicitud.ObjTipoPersonaID = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[31].Value.ToString());
                    clsSolicitud.ObjPaisOrigenID = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[32].Value.ToString());
                    clsSolicitud.ObjSexoID = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[33].Value.ToString());
                    clsSolicitud.ObjEstadoCivil = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[34].Value.ToString());
                    ...
                    clsSolicitud.IdObligacion = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[21].Value.ToString());
                    clsSolicitud.Propietario = dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[22].Value.ToString();
                    clsSolicitud.ObjSectorID = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[35].Value.ToString());
                    clsSolicitud.ObjMonedaID = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[36].Value.ToString());
                    clsSolicitud.PeriocidadInt = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[37].Value.ToString());
                    clsSolicitud.PeriocidadPrin = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[38].Value.ToString());
                    clsSolicitud.Monto = Decimal.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[27].Value.ToString());
                    clsSolicitud.objTipoClienteID = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[39].Value.ToString());
                    clsSolicitud.ObjEstadoSolicitudID = int.Parse(dgvSolicitudes.Rows[dgvSolicitudes.SelectedRows[0].Index].Cells[40].Value.ToString());
        ...
        public void Carga()
        {
            ...
            dgvSolicitudes.Columns[30].Visible = false;
            dgvSolicitudes.Columns[31].Visible = false;
